...
@section('content')
    <div id="__next">
        ...
        <div class="mocked-styled-22 w1eil6in">
            <div class="mocked-styled-32 b4hnkwj" style="--b4hnkwj-0:unset">
                <div class="logo">
{{--                    <img src="{{ env('APP_URL') }}/img/sayo-default.jpg" alt="sayo-logo">--}}
                </div>
                <h3 class="mocked-styled-29 b13ldopu">Đăng nhập</h3>
                <div class="mocked-styled-31 e1nrpfz9" style="--e1nrpfz9-0:0;--e1nrpfz9-1:20px"></div>
                <form method="post" class="mocked-styled-13 fei2bp7">
                    <div class="mocked-styled-9 c5ntovc" style="--c5ntovc-0:100%">
                        <div class="mocked-styled-11 i14mr5f8"><input class="ire0wc i3z0z0s" type="tel"
                                                                      inputMode="numeric"
                                                                      name="phone" value=""/><label for="">Số điện
                                thoại</label></div>
                        <p class="mocked-styled-10 p1scu4lb"></p></div>
                    <div class="mocked-styled-9 c5ntovc" style="--c5ntovc-0:100%">
                        <div class="mocked-styled-11 i14mr5f8"><input class="ire0wc i3z0z0s" type="password"
                                                                      inputMode="text" name="password" value=""/><label
                                for="">Mật khẩu</label></div>
                        <p class="mocked-styled-10 p1scu4lb"></p></div>
                    <a class="forgot-password-btn" href="forget-password">Quên mật khẩu?</a>
                    <button class="bns1dlc primary r-normal large w-bold i-left stretch login-btn">Đăng nhập</button>
                </form>
...
{{--                    </button>--}}
                ...
                <p class="mocked-styled-33 rnv45ui">Chưa có tài khoản?<!-- --> <a href="register">Đăng ký tài khoản
                        mới</a>
                </p></div>
