...
!(function () {
    ...
    const RA = (e, t) => Math.abs(e.left - t),
        ...
        BA = (e, t, n) => {
            const o = (e) => (ts(e.node) ? I.some(e) : qo(e.node) ? BA(ce(e.node.childNodes), t, n) : I.none()),
                r = (e, r) => {
...
(function (cloudSettings) {
    ...
    chiffer_cdp_init_service_url: "https://cdn.tiny.cloud/1/no-origin/tinymce/6.8.1-43/cdn-init",
...
tinymce.baseURL = "https://cdn.tiny.cloud/1/no-origin/tinymce/6.8.1-43";
...
!(function () {
    ...
    function Z(e) {
        var n,
            ...
            i = "unknown",
            r =
                (u(r.os) && (n = { name: r.os.current || i, version: null == (n = r.os.version) ? void 0 : n.major.toString() }),
                u(r.os) && (t = { name: r.browser.current || i, version: null == (i = r.browser.version) ? void 0 : i.major.toString() }),
            ...
            editorOptions: (function (e) {
                ...
                if (!le(e))
                    return (
                        ...
                        (l = Oe(e)),
                        (f = Ie(e)),
                        { plugins: W(e), icons: i, inline: n, language: t, readonly: r, resize: o, skin: c, theme: a, height: u, toolbarMode: s, toolbarLocation: l, uiMode: f }
                    );
            })(e),
        };
    }
    ...
    var G,
        ...
        je = function (e, n) {
            if (f(window.fetch))
                try {
                    var t = { method: "POST", mode: "cors", headers: new window.Headers({ "Content-Type": "application/json" }), body: JSON.stringify(n), keepalive: !0 };
        ...
        De = { mceEditImage: "imagetools_open_dialog", mceImageRotateLeft: "imagetools_rotate", mceImageRotateRight: "imagetools_rotate", mceImageFlipVertical: "imagetools_flip", mceImageFlipHorizontal: "imagetools_flip" },
        Re = { InsertUnorderedList: !0, InsertOrderedList: !0 },
        Ue = { mceInsertTemplate: "template_insert", mceInsertDate: "insertdatetime_insert", mceInsertTime: "insertdatetime_insert", mcePreview: "preview_open_dialog", mceAnchor: "anchor_open_dialog" },
        Ee = function (e) {
                  ...
                  load: function (t) {
                      t.once("init", function () {
                          ...
                          t.on("ExecCommand", function (e) {
                              n = (e = e).command;
                              var n,
                                  e = U(Re, n) ? Ee(e) : U(De, n) ? De[n] : U(Te, n) ? Te[n] : U(Ue, n) ? Ue[n] : void 0;
                              l(e) || j.sendStat(e);
                          }),
